module.exports = new Object({
    ...
    async execute(client, message, args, prefix, color, dispatcher) {
        if (!dispatcher.queue.length) return await client.util.msgReply(message, `<a:gb_music:1118884144848576542> Now Playing - [${dispatcher.queue.current.title}](${dispatcher.queue.current.uri})`, color)
